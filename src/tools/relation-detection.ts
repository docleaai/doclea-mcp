 ...
 */
const DetectionMethodSchema = z.enum(["semantic", "keyword", "file_overlap", "temporal"]);
...
export const GetSuggestionsInputSchema = z.object({
	...
	detectionMethod: DetectionMethodSchema.optional().describe("Filter by detection method"),
...
export const BulkReviewInputSchema = z.object({
	suggestionIds: z.array(z.string()).min(1).describe("Suggestion IDs to review"),
