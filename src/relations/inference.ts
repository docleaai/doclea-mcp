...
const INFERENCE_RULES: InferenceRule[] = [
	...
	// Bug-fix → Bug implies the fix addresses the bug (via solution type)
	{
		sourceType: "solution",
		targetType: "bug",
		relationType: "solves",
	...
	// Context typically references other memories
	{
		sourceType: "context",
		targetType: "decision",
		relationType: "references",
...
export function isValidRelationType(
	...
	return possibleTypes.includes(relationType) || genericTypes.includes(relationType);
}
